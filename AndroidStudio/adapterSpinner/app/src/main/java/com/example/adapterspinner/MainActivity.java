...
public class MainActivity extends AppCompatActivity {
    ...
    TextView title;
    ImageView ivposter;
    Integer[] postid = {R.drawable.mov01,R.drawable.mov44,R.drawable.mov03,R.drawable.mov04,R.drawable.mov05
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(
                MainActivity.this,
                android.R.layout.simple_spinner_dropdown_item,posterTitle
        );
